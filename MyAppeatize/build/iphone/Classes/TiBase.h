...
// in simulator we redefine to format for MyAppeatize Developer console
...
{\
	NSString * exceptionName = [@"org.myappeatize." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.myappeatize";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIMyAppeatizeNativeItemNone = -1, 
	UIMyAppeatizeNativeItemSpinner = -2,
	UIMyAppeatizeNativeItemProgressBar = -3,
	
	UIMyAppeatizeNativeItemSlider = -4,
	UIMyAppeatizeNativeItemSwitch = -5,
	UIMyAppeatizeNativeItemMultiButton = -6,
	UIMyAppeatizeNativeItemSegmented = -7,
	
	UIMyAppeatizeNativeItemTextView = -8,
	UIMyAppeatizeNativeItemTextField = -9,
	UIMyAppeatizeNativeItemSearchBar = -10,
	
	UIMyAppeatizeNativeItemPicker = -11,
	UIMyAppeatizeNativeItemDatePicker = -12,
	
	UIMyAppeatizeNativeItemInfoLight = -13,
	UIMyAppeatizeNativeItemInfoDark = -14,
	
	UIMyAppeatizeNativeItemDisclosure = -15,
	
	UIMyAppeatizeNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all MyAppeatize instances of
