...
@interface MyAppeatizeObject : KrollCoverageObject {
#else
@interface MyAppeatizeObject : KrollObject {
#endif
@private
...
extern NSString * MyAppeatize$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	MyAppeatizeObject *_myappeatize;
    KrollObject* console;
	BOOL shutdown;
