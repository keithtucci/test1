...
//@interface MyAppeatizeObject : NSObject
//@end

@interface MyAppeatizeObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[MyAppeatizeObject class]])
		{
			for (NSString *key in [[(MyAppeatizeObject*)o modules] allKeys])
			{
