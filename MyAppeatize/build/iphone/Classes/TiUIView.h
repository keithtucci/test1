...
/**
 Base class for all MyAppeatize views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the MyAppeatize view hierarchy (such as wrapped iOS UIViews) was touched.
