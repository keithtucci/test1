...
function Controller() {
    ...
    this.__controllerPath = "reservations";
    if (arguments[0]) {
    ...
    $.__views.viewNoData.add($.__views.__alloyId90);
    ...
    $.__views.labelNoDataMessage = Ti.UI.createLabel({
        ...
        left: 20,
        right: 20,
        text: "Contact Appeatize to learn more about our Reservations service.",
        id: "labelNoDataMessage"
    });
    $.__views.__alloyId90.add($.__views.labelNoDataMessage);
    $.__views.tab = Ti.UI.createTab({
        title: "Reservations",
        icon: "img/reservations.png",
        activeIcon: "img/reservations-fill.png",
        window: $.__views.win,
        id: "tab"
    });
